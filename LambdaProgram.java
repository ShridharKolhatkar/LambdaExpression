...
public class LambdaProblem {
	...
	public static void main(String[] args) {
		...
		// print the statement
		System.out.println(f1.checkValidFirstUserName("Shridhar"));
		System.out.println(f2.checkValidLastName("Kolhatkar"));
		System.out.println(f3.checkValidMobilenumber("91 8788586956"));
		System.out.println(f4.checkValidEmailId("shridharkolhatkar@gamil.com"));
		System.out.println(f5.checkValidPassword("Shridhar@123"));
	}
}
